...
impl CPU {
    pub fn execute(&mut self, opcode: u8, is_cb__prefix: bool) {
        if is_cb__prefix {
            ...
            match opcode {
                ...
                0xC1 => self.pop_r16stk(Register16Stk::BC),
                0xC2 => self.jp_cond_imm16(Condition::NZ),
                0xC3 => self.jp_imm16(),
                0xC4 => self.call_cond_imm16(Condition::NZ),
                0xC5 => self.push_r16stk(Register16Stk::BC),
                0xC6 => self.add_a_imm8(),
                0xC7 => self.rst_tgt3(RstVec::RST00),
                0xC8 => self.ret_cc(Condition::Z),
                0xC9 => self.ret(),
                0xCA => self.jp_cond_imm16(Condition::Z),
                0xCB => self.nop(), // CB prefix
                0xCC => self.call_cond_imm16(Condition::Z),
                0xCD => self.call_imm16(),
                0xCE => self.adc_a_imm8(),
                0xCF => self.rst_tgt3(RstVec::RST08),

                0xD0 => self.ret_cc(Condition::NC),
                0xD1 => self.pop_r16stk(Register16Stk::DE),
                0xD2 => self.jp_cond_imm16(Condition::NC),
                // $D3 invalid
                ...
                0xD9 => self.reti(),
                0xDA => self.jp_cond_imm16(Condition::C),
                // $DB invalid
                0xDC => self.call_cond_imm16(Condition::C),
                // $DD invalid
                0xDE => self.sbc_a_imm8(),
                0xDF => self.rst_tgt3(RstVec::RST18),

                0xE0 => self.ldh_imm8_a(),
                0xE1 => self.pop_r16stk(Register16Stk::HL),
                0xE2 => self.ldh_c_a(),
                // $E3 invalid
                // $E4 invalid
                0xE5 => self.push_r16stk(Register16Stk::HL),
                0xE6 => self.and_a_imm8(),
                0xE7 => self.rst_tgt3(RstVec::RST20),
                ...
                0xEF => self.rst_tgt3(RstVec::RST28),

                0xF0 => self.ldh_a_imm8(),
                0xF1 => self.pop_r16stk(Register16Stk::AF),
                0xF2 => self.ldh_a_c(),
                0xF3 => self.di(),
                // $F4 invalid
                0xF5 => self.push_r16stk(Register16Stk::AF),
                0xF6 => self.or_a_imm8(),
                0xF7 => self.rst_tgt3(RstVec::RST30),
                0xF8 => self.ld_hl_sp_plus_imm8(),
                0xF9 => self.ld_sp_hl(),
                ...
                // $FD invalid
                0xFE => self.cp_a_imm8(),
                0xFF => self.rst_tgt3(RstVec::RST38),
    ...
    fn execute_cb(&mut self, opcode: u8) {
        ...
        match opcode {
            ...
            0x06 => self.rlc_r8(Register8::HLIndirect),
            ...
            0x0E => self.rrc_r8(Register8::HLIndirect),
            ...
            0x16 => self.rl_r8(Register8::HLIndirect),
            ...
            0x1E => self.rr_r8(Register8::HLIndirect),
            ...
            0x26 => self.sla_r8(Register8::HLIndirect),
            ...
            0x2E => self.sra_r8(Register8::HLIndirect),
            ...
            0x36 => self.swap_r8(Register8::HLIndirect),
            ...
            0x3E => self.srl_r8(Register8::HLIndirect),
            0x3F => self.srl_r8(Register8::A),

            0x40 => self.bit_b3_r8(Register8::B, 0),
            0x41 => self.bit_b3_r8(Register8::C, 0),
            0x42 => self.bit_b3_r8(Register8::D, 0),
            0x43 => self.bit_b3_r8(Register8::E, 0),
            0x44 => self.bit_b3_r8(Register8::H, 0),
            0x45 => self.bit_b3_r8(Register8::L, 0),
            0x46 => self.bit_b3_r8(Register8::HLIndirect, 0),
            0x47 => self.bit_b3_r8(Register8::A, 0),
            0x48 => self.bit_b3_r8(Register8::B, 1),
            0x49 => self.bit_b3_r8(Register8::C, 1),
            0x4A => self.bit_b3_r8(Register8::D, 1),
            0x4B => self.bit_b3_r8(Register8::E, 1),
            0x4C => self.bit_b3_r8(Register8::H, 1),
            0x4D => self.bit_b3_r8(Register8::L, 1),
            0x4E => self.bit_b3_r8(Register8::HLIndirect, 1),
            0x4F => self.bit_b3_r8(Register8::A, 1),

            0x50 => self.bit_b3_r8(Register8::B, 2),
            0x51 => self.bit_b3_r8(Register8::C, 2),
            0x52 => self.bit_b3_r8(Register8::D, 2),
            0x53 => self.bit_b3_r8(Register8::E, 2),
            0x54 => self.bit_b3_r8(Register8::H, 2),
            0x55 => self.bit_b3_r8(Register8::L, 2),
            0x56 => self.bit_b3_r8(Register8::HLIndirect, 2),
            0x57 => self.bit_b3_r8(Register8::A, 2),
            0x58 => self.bit_b3_r8(Register8::B, 3),
            0x59 => self.bit_b3_r8(Register8::C, 3),
            0x5A => self.bit_b3_r8(Register8::D, 3),
            0x5B => self.bit_b3_r8(Register8::E, 3),
            0x5C => self.bit_b3_r8(Register8::H, 3),
            0x5D => self.bit_b3_r8(Register8::L, 3),
            0x5E => self.bit_b3_r8(Register8::HLIndirect, 3),
            0x5F => self.bit_b3_r8(Register8::A, 3),

            0x60 => self.bit_b3_r8(Register8::B, 4),
            0x61 => self.bit_b3_r8(Register8::C, 4),
            0x62 => self.bit_b3_r8(Register8::D, 4),
            0x63 => self.bit_b3_r8(Register8::E, 4),
            0x64 => self.bit_b3_r8(Register8::H, 4),
            0x65 => self.bit_b3_r8(Register8::L, 4),
            0x66 => self.bit_b3_r8(Register8::HLIndirect, 4),
            0x67 => self.bit_b3_r8(Register8::A, 4),
            0x68 => self.bit_b3_r8(Register8::B, 5),
            0x69 => self.bit_b3_r8(Register8::C, 5),
            0x6A => self.bit_b3_r8(Register8::D, 5),
            0x6B => self.bit_b3_r8(Register8::E, 5),
            0x6C => self.bit_b3_r8(Register8::H, 5),
            0x6D => self.bit_b3_r8(Register8::L, 5),
            0x6E => self.bit_b3_r8(Register8::HLIndirect, 5),
            0x6F => self.bit_b3_r8(Register8::A, 5),

            0x70 => self.bit_b3_r8(Register8::B, 6),
            0x71 => self.bit_b3_r8(Register8::C, 6),
            0x72 => self.bit_b3_r8(Register8::D, 6),
            0x73 => self.bit_b3_r8(Register8::E, 6),
            0x74 => self.bit_b3_r8(Register8::H, 6),
            0x75 => self.bit_b3_r8(Register8::L, 6),
            0x76 => self.bit_b3_r8(Register8::HLIndirect, 6),
            0x77 => self.bit_b3_r8(Register8::A, 6),
            0x78 => self.bit_b3_r8(Register8::B, 7),
            0x79 => self.bit_b3_r8(Register8::C, 7),
            0x7A => self.bit_b3_r8(Register8::D, 7),
            0x7B => self.bit_b3_r8(Register8::E, 7),
            0x7C => self.bit_b3_r8(Register8::H, 7),
            0x7D => self.bit_b3_r8(Register8::L, 7),
            0x7E => self.bit_b3_r8(Register8::HLIndirect, 7),
            0x7F => self.bit_b3_r8(Register8::A, 7),

            0x80 => self.res_b3_r8(Register8::B, 0),
            0x81 => self.res_b3_r8(Register8::C, 0),
            0x82 => self.res_b3_r8(Register8::D, 0),
            0x83 => self.res_b3_r8(Register8::E, 0),
            0x84 => self.res_b3_r8(Register8::H, 0),
            0x85 => self.res_b3_r8(Register8::L, 0),
            0x86 => self.res_b3_r8(Register8::HLIndirect, 0),
            0x87 => self.res_b3_r8(Register8::A, 0),
            0x88 => self.res_b3_r8(Register8::B, 1),
            0x89 => self.res_b3_r8(Register8::C, 1),
            0x8A => self.res_b3_r8(Register8::D, 1),
            0x8B => self.res_b3_r8(Register8::E, 1),
            0x8C => self.res_b3_r8(Register8::H, 1),
            0x8D => self.res_b3_r8(Register8::L, 1),
            0x8E => self.res_b3_r8(Register8::HLIndirect, 1),
            0x8F => self.res_b3_r8(Register8::A, 1),

            0x90 => self.res_b3_r8(Register8::B, 2),
            0x91 => self.res_b3_r8(Register8::C, 2),
            0x92 => self.res_b3_r8(Register8::D, 2),
            0x93 => self.res_b3_r8(Register8::E, 2),
            0x94 => self.res_b3_r8(Register8::H, 2),
            0x95 => self.res_b3_r8(Register8::L, 2),
            0x96 => self.res_b3_r8(Register8::HLIndirect, 2),
            0x97 => self.res_b3_r8(Register8::A, 2),
            0x98 => self.res_b3_r8(Register8::B, 3),
            0x99 => self.res_b3_r8(Register8::C, 3),
            0x9A => self.res_b3_r8(Register8::D, 3),
            0x9B => self.res_b3_r8(Register8::E, 3),
            0x9C => self.res_b3_r8(Register8::H, 3),
            0x9D => self.res_b3_r8(Register8::L, 3),
            0x9E => self.res_b3_r8(Register8::HLIndirect, 3),
            0x9F => self.res_b3_r8(Register8::A, 3),

            0xA0 => self.res_b3_r8(Register8::B, 4),
            0xA1 => self.res_b3_r8(Register8::C, 4),
            0xA2 => self.res_b3_r8(Register8::D, 4),
            0xA3 => self.res_b3_r8(Register8::E, 4),
            0xA4 => self.res_b3_r8(Register8::H, 4),
            0xA5 => self.res_b3_r8(Register8::L, 4),
            0xA6 => self.res_b3_r8(Register8::HLIndirect, 4),
            0xA7 => self.res_b3_r8(Register8::A, 4),
            0xA8 => self.res_b3_r8(Register8::B, 5),
            0xA9 => self.res_b3_r8(Register8::C, 5),
            0xAA => self.res_b3_r8(Register8::D, 5),
            0xAB => self.res_b3_r8(Register8::E, 5),
            0xAC => self.res_b3_r8(Register8::H, 5),
            0xAD => self.res_b3_r8(Register8::L, 5),
            0xAE => self.res_b3_r8(Register8::HLIndirect, 5),
            0xAF => self.res_b3_r8(Register8::A, 5),
            0xB0 => self.res_b3_r8(Register8::B, 6),
            0xB1 => self.res_b3_r8(Register8::C, 6),
            0xB2 => self.res_b3_r8(Register8::D, 6),
            0xB3 => self.res_b3_r8(Register8::E, 6),
            0xB4 => self.res_b3_r8(Register8::H, 6),
            0xB5 => self.res_b3_r8(Register8::L, 6),
            0xB6 => self.res_b3_r8(Register8::HLIndirect, 6),
            0xB7 => self.res_b3_r8(Register8::A, 6),
            0xB8 => self.res_b3_r8(Register8::B, 7),
            0xB9 => self.res_b3_r8(Register8::C, 7),
            0xBA => self.res_b3_r8(Register8::D, 7),
            0xBB => self.res_b3_r8(Register8::E, 7),
            0xBC => self.res_b3_r8(Register8::H, 7),
            0xBD => self.res_b3_r8(Register8::L, 7),
            0xBE => self.res_b3_r8(Register8::HLIndirect, 7),
            0xBF => self.res_b3_r8(Register8::A, 7),

            0xC0 => self.set_b3_r8(Register8::B, 0),
            0xC1 => self.set_b3_r8(Register8::C, 0),
            0xC2 => self.set_b3_r8(Register8::D, 0),
            0xC3 => self.set_b3_r8(Register8::E, 0),
            0xC4 => self.set_b3_r8(Register8::H, 0),
            0xC5 => self.set_b3_r8(Register8::L, 0),
            0xC6 => self.set_b3_r8(Register8::HLIndirect, 0),
            0xC7 => self.set_b3_r8(Register8::A, 0),
            0xC8 => self.set_b3_r8(Register8::B, 1),
            0xC9 => self.set_b3_r8(Register8::C, 1),
            0xCA => self.set_b3_r8(Register8::D, 1),
            0xCB => self.set_b3_r8(Register8::E, 1),
            0xCC => self.set_b3_r8(Register8::H, 1),
            0xCD => self.set_b3_r8(Register8::L, 1),
            0xCE => self.set_b3_r8(Register8::HLIndirect, 1),
            0xCF => self.set_b3_r8(Register8::A, 1),

            0xD0 => self.set_b3_r8(Register8::B, 2),
            0xD1 => self.set_b3_r8(Register8::C, 2),
            0xD2 => self.set_b3_r8(Register8::D, 2),
            0xD3 => self.set_b3_r8(Register8::E, 2),
            0xD4 => self.set_b3_r8(Register8::H, 2),
            0xD5 => self.set_b3_r8(Register8::L, 2),
            0xD6 => self.set_b3_r8(Register8::HLIndirect, 2),
            0xD7 => self.set_b3_r8(Register8::A, 2),
            0xD8 => self.set_b3_r8(Register8::B, 3),
            0xD9 => self.set_b3_r8(Register8::C, 3),
            0xDA => self.set_b3_r8(Register8::D, 3),
            0xDB => self.set_b3_r8(Register8::E, 3),
            0xDC => self.set_b3_r8(Register8::H, 3),
            0xDD => self.set_b3_r8(Register8::L, 3),
            0xDE => self.set_b3_r8(Register8::HLIndirect, 3),
            0xDF => self.set_b3_r8(Register8::A, 3),

            0xE0 => self.set_b3_r8(Register8::B, 4),
            0xE1 => self.set_b3_r8(Register8::C, 4),
            0xE2 => self.set_b3_r8(Register8::D, 4),
            0xE3 => self.set_b3_r8(Register8::E, 4),
            0xE4 => self.set_b3_r8(Register8::H, 4),
            0xE5 => self.set_b3_r8(Register8::L, 4),
            0xE6 => self.set_b3_r8(Register8::HLIndirect, 4),
            0xE7 => self.set_b3_r8(Register8::A, 4),
            0xE8 => self.set_b3_r8(Register8::B, 5),
            0xE9 => self.set_b3_r8(Register8::C, 5),
            0xEA => self.set_b3_r8(Register8::D, 5),
            0xEB => self.set_b3_r8(Register8::E, 5),
            0xEC => self.set_b3_r8(Register8::H, 5),
            0xED => self.set_b3_r8(Register8::L, 5),
            0xEE => self.set_b3_r8(Register8::HLIndirect, 5),
            0xEF => self.set_b3_r8(Register8::A, 5),

            0xF0 => self.set_b3_r8(Register8::B, 6),
            0xF1 => self.set_b3_r8(Register8::C, 6),
            0xF2 => self.set_b3_r8(Register8::D, 6),
            0xF3 => self.set_b3_r8(Register8::E, 6),
            0xF4 => self.set_b3_r8(Register8::H, 6),
            0xF5 => self.set_b3_r8(Register8::L, 6),
            0xF6 => self.set_b3_r8(Register8::HLIndirect, 6),
            0xF7 => self.set_b3_r8(Register8::A, 6),
            0xF8 => self.set_b3_r8(Register8::B, 7),
            0xF9 => self.set_b3_r8(Register8::C, 7),
            0xFA => self.set_b3_r8(Register8::D, 7),
            0xFB => self.set_b3_r8(Register8::E, 7),
            0xFC => self.set_b3_r8(Register8::H, 7),
            0xFD => self.set_b3_r8(Register8::L, 7),
            0xFE => self.set_b3_r8(Register8::HLIndirect, 7),
            0xFF => self.set_b3_r8(Register8::A, 7),
        }
    }
}
